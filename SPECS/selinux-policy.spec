...
%global commit d731f00856041aafc3b95a0b3f108ccc9485e160
...
* Thu Feb 19 2026 Vit Mojzis <vmojzis@redhat.com> - 42.1.7-1.2
- Update specfile triggers for DSP modules (RHEL-132492)
- Update specfile trigger for smartmontools
- Update specfile trigger for openwsman
- Move triggerin scriptlets to the parent packages (RHEL-150914)
- Rebuild policy before running {binsbin|varrun}-convert.sh (RHEL-128498)
