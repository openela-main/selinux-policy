...
Resolves: rhbz#1656891

* Wed Jun 05 2019 Lukas Vrabec <lvrabec@redhat.com> - 3.14.3-8
- Allow sbd_t domain to read tmpfs_t symlinks
Resolves: rhbz#1715134

* Mon Jun 03 2019 Lukas Vrabec <lvrabec@redhat.com> - 3.14.3-7
- Allow kadmind_t domain to read home config data
Resolves: rhbz#1664983
- Allow sbd_t domain to readwrite cgroups
Resolves: rhbz#1715134
- Label /var/log/pacemaker/pacemaker as cluster_var_log_t
Resolves: rhbz#1712058
- Allow certmonger_t domain to manage named cache files/dirs

* Mon May 27 2019 Lukas Vrabec <lvrabec@redhat.com> - 3.14.3-6
- Allow kadmind_t domain to read pkcs11 module configs
Resolves: rhbz#1664983
- Allow kadmind_t domain to read named_cache_t files
Resolves: rhbz#1703241
...
Resolves: rhbz#1709372

* Thu May 02 2019 Lukas Vrabec <lvrabec@redhat.com> - 3.14.3-4
- Rebase with Fedora 30 package selinux-policy-3.14.3-34.fc30
Resolves: rhbz#1673107

* Tue Apr 23 2019 Lukas Vrabec <lvrabec@redhat.com> - 3.14.3-3
- Rebase with Fedora 30 package selinux-policy-3.14.3-31.fc30
Resolves: rhbz#1673107

* Tue Apr 16 2019 Lukas Vrabec <lvrabec@redhat.com> - 3.14.3-2
- Fix interface kernel_mounton_kernel_sysctl()
Resolves: rhbz#1700222

* Wed Apr 10 2019 Lukas Vrabec <lvrabec@redhat.com> - 3.14.3-1
- Rebase with Fedora 30 package selinux-policy-3.14.3-28.fc30
Resolves: rhbz#1673107
...
* Tue Jan 29 2019 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-53
...
- Allow transition from init_t domain to user_t domain during ssh login with confined user user_u
Resolves: rhbz#1664448

* Thu Jan 24 2019 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-52
- Fix userdom_admin_user_template() interface by adding bluetooth,alg,dccp create_stream_socket permissions.
Resolves: rhbz#1557301

* Mon Jan 14 2019 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-51
- Allow tangd_t domain to bind on tcp ports labeled as tangd_port_t
Resolves: rhbz#1664345
- Create tangd_port_t with default label tcp/7406
Resolves: rhbz#1664345
- Remove tangd_t domain from permissive domains.
Resolves: rhbz#1664345

* Fri Jan 11 2019 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-50
- Change label of /usr/libexec/lm_sensors/sensord-service-wrapper from lsmd_exec_t to sensord_exec_t
Resolves: rhbz#1656055
- Make kpatch_t domain application domain to allow users to execute kpatch in kpatch_t domain.
Resolves: rhbz#1630198
...
* Tue Dec 11 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-49
- Update nslcd_t domain to allow view kernel and systemd keyrings
Resolves: rhbz#1657916
- Allow arpwatch_t domains to execute shell BZ(1644568)
- Allow processes labeled as ipa_otpd_t stream connect to sssd.
- Add new SELinux domain pcp_plugin_t.
Resolves: rhbz#1648386
- Remove all ganesha bits from gluster and rpc policy
Resolves: rhbz#1639227
- Label /usr/share/spamassassin/sa-update.cron as spamd_update_exec_t
Resolves: rhbz#1656837
- Add dac_override capability to ssad_t domains
Resolves: rhbz#1655551
- Allow pesign_t domain to read gnome home configs
Resolves: rhbz#1644796
- Label /usr/libexec/lm_sensors/sensord-service-wrapper as lsmd_exec_t
Resolves: rhbz#1656055
- Allow rngd_t domains read kernel state
Resolves: rhbz#1656054
- Allow certmonger_t domains to read bind cache
Resolves: rhbz#1655077
- Allow ypbind_t domain to stream connect to sssd
Resolves: rhbz#1583953
- Allow rngd_t domain to setsched
Resolves: rhbz#1653872
- Add interface init_view_key()
- Allow systemd to mmap all pidfiles
Resolves: rhbz#1622548
- Add files_map_all_pids() interface
- Allow passwd_t domain mamange sssd public nad lib files, read pid files and send signals to sssd_t domains
Resolves: rhbz#1657291
...
* Mon Oct 22 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-46
- Add dac_override capability to ftpd_t domain
Resolves: rhbz#1641049
- Allow X display manager to check status and reload services which are part of x_domain attribute
Resolves: rhbz#1641082

* Fri Oct 19 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-45
...
* Sat Oct 13 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-44
- Update rpm macros for selinux policy from sources repository: https://github.com/fedora-selinux/selinux-policy-macros
Resolves: rhbz#1633198
- Allow boltd_t to read fwupd_t processes state
- Turn named_write_master_zones boolean on by default.
Resolves: rhbz#1633158
- Label /etc/rhsm as rhsmcertd_config_t
Resolves: rhbz#1636212
- Allow httpd_t domain to write to httpd_config_t dirs if httpd_run_ipa boolean is turned on
Resolves: rhbz#1624930
- Allow dhcpd_t domain to mmap dhcpd_state_t files
Resolves: rhbz#1635643
- Allow abrt_t domain to manage usr_t dirs
Resolves: rhbz#1619001
- Allow certmonger_t domain to manage cockpit pid files
Resolves: rhbz#1629685
- Update opafm_t domain after basic testing this service
Resolves: rhbz#1627861
- Allow systemd-tty-ask to ask for password of encrypted partions during boot
Resolves: rhbz#1638666
- Update sysnet_read_dhcp_config interface to allow caller domain also mmap dhcp_etc_t files
- Add interface files_manage_usr_dirs()

* Wed Oct 10 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-43
- Allow ibacm_t domain to read/write to infiniband devices Allow ibacm_t domain to getattr tmpfs_t filesystem.
Resolves: rhbz#1635674
- Update SELinux policy for libreswan based on the latest rebase 3.26
Resolves: rhbz#1637089

* Mon Oct 08 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-42
- Allow cockpit to create motd file in /var/run/cockpit
Resolves: rhbz#1629678
- Allow cockpit_t domain to read systemd state
Resolves: rhbz#1629588

* Thu Oct 04 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-41
- Tomcat should not be unconfined domain
...
Resolves: rhbz#1629678
Resolves: rhbz#1629685
Resolves: rhbz#1626100
Resolves: rhbz#1629588
Resolves: rhbz#1630317

* Sat Sep 15 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-40
- Tomcat should not be unconfined domain
- Allow cockpit_t domain to read systemd state
...
Resolves: rhbz#1615318
Resolves: rhbz#1619001
Resolves: rhbz#1627646

* Fri Sep 07 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-39
- Merge remote-tracking branch 'fedora-contrib/f28' into rhel8.0-contrib
- Tomcat should not be unconfined domain
- Update ibacm_read_pid_files interface to allow also reading link files
- Allow zebra_t domain to create packet_sockets
- Allow opafm_t domain to list sysfs
...
- Merge remote-tracking branch 'fedora-base/f28' into rhel8.0-base
- Revert "Add new interface dev_map_userio()"
- Add new interface dev_map_userio()
- Allow systemd to read ibacm pid files
...
Resolves: rhbz#1623411
Resolves: rhbz#1624648
Resolves: rhbz#1596618
Resolves: rhbz#1574878
Resolves: rhbz#1577324
Resolves: rhbz#1625202
Resolves: rhbz#1581715
Resolves: rhbz#1625127

* Tue Aug 28 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-38
- Allow ovs-vswitchd labeled as openvswitch_t domain communicate with qemu-kvm via UNIX stream socket
Resolves: rhbz#1621142
...
* Tue Aug 21 2018 Lukas Vrabec  <lvrabec@redhat.com> - 3.14.1-37
- Dontaudit abrt_t domain to write to usr_t dirs
- Revert "Allow rpcbind to bind on all unreserved udp ports"
- Allow rpcbind to bind on all unreserved udp ports
- Allow virtlogd to execute itself
...
* Mon Aug 13 2018 Lukas Vrabec  <lvrabec@redhat.com> - 3.14.1-36
- Add missing tarball from sources
Resolves: rhbz#1615312

* Mon Aug 13 2018 Daniel Kopeček <dkopecek@redhat.com> - 3.14.1-35
- Use explicit path BuildRequires to get /usr/bin/python3 inside the buildroot
Resolves: rhbz#1615312

* Fri Aug 10 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-34
...
* Sun Jul 29 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-33
...
* Thu Jul 26 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-32
...
* Wed Jul 18 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-31
...
* Fri Jun 29 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-30
- Add ibacm policy
...
* Fri Jun 08 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-29
...
- Allow virtual machines to manage cephfs filesystems.
- Allow rhsmcertd_t domain to read sssd public files and stream connect to sssd
...
* Wed Jun 06 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-28
...
* Sat May 26 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-27
...
- Add dac_override capability to cgconfig_t domain BZ(1574649)
- Add dac_override to glusterd_t domain BZ(1578501)
- Allow fsdaemon_t to create own fsdaemon_var_lib_t dirs BZ(1569724)
- Allow plymouth_t domain to read/write systemd sockets BZ(1578882)
- Allow use of U2F Yubikey as authentication for a sudo command BZ(1578915)
- Append map permission to apache_read_modules() interface
- Allow certwatch_t domain to getattr of extended attributes fs_t filesystem
- Add new interface: dirsrv_noatsecure()
...
- Allow sysadm user to sys_ptrace cap_userns
...
- Allow ssh client to read network state BZ(1574174)
- Allow ssh basic client to read/write to tun tap devices BZ(1574184)
- Allow ssh basic client to create tun sockets BZ(1574186)
- Disable secure mode environment cleansing for dirsrv_t

* Mon May 21 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-26
- Disable secure mode environment cleansing for dirsrv_t
- - Allow udev execute /usr/libexec/gdm-disable-wayland in xdm_t domain which allows create /run/gdm/custom.conf with proper xdm_var_run_t label.
...
* Sat Apr 28 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-24
- Allow unconfined_domain_type to create libs filetrans named content BZ(1513806)

* Fri Apr 27 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-23
...
* Wed Apr 18 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-22
...
* Mon Mar 26 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-18
...
* Sun Mar 25 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-17
...
* Wed Mar 21 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-16
- Improve bluetooth_stream_socket interface to allow caller domain also send bluetooth sockets
- Allow tcpd_t bind on sshd_port_t if ssh_use_tcpd() is enabled
- Allow semanage_t domain mmap usr_t files
- Add new boolean: ssh_use_tcpd()

* Tue Mar 20 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-15
...
* Thu Mar 15 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-14
...
* Mon Mar 05 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-11
...
* Thu Feb 22 2018 Lukas Vrabec <lvrabec@redhat.com> - 3.14.1-10
